...
(
SELECT
'restore database ['+ b.database_name + '] from ' + STUFF((SELECT ' , disk = ''' + a.physical_device_name +''' with norecovery, replace;'
 ...
 where rownum = 1 AND b.media_set_id=m.media_set_id  AND B.backup_type = 'DATABASE' 
